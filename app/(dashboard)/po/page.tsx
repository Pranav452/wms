...
export default function POPage() {
  ...
  if (loading) return <><Header title="PO Tracking" breadcrumb="PO" /><LoadingState /></>
    ...
    <>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-xs text-amber-800">
          ...
          Search by PO number (e.g. <span className="font-mono">STNITFABP230426-10</span>) to find its dispatch status.
        </div>
